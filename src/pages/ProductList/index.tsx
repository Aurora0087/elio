    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins gap-9 items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-start justify-start w-full">
          <div className="flex flex-row gap-4 items-center justify-start ml-36 md:ml-[0] md:px-5 w-[11%] md:w-full">
            <Text
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1632px] mt-[70px] mx-auto md:px-5 w-full">
            <div className="flex md:flex-1 flex-col items-start justify-start pt-1.5 w-[16%] md:w-full">
            ...
            <div className="flex md:flex-1 flex-col gap-8 items-center justify-start w-[84%] md:w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between pt-0.5 w-full">
                <Text
                  className="sm:mt-0 mt-1 text-gray-500 text-lg"
                  size="txtPoppinsMedium18Gray500"
                >
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="md:gap-5 gap-8 grid sm:grid-cols-1 md:grid-cols-3 grid-cols-5 justify-center min-h-[auto] w-full">
                    ...
                    <div className="flex flex-1 flex-col gap-4 justify-start pb-1 w-full">
                      ...
                      />
                      <div className="flex flex-col gap-2 items-center justify-start md:ml-[0] ml-[50px] w-auto">
                        <Text
                          className="text-2xl md:text-[22px] text-center text-gray-800 sm:text-xl"
                          size="txtPoppinsMedium24"
                        >
